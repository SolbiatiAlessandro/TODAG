...
The concept is to structure the TODOs in a TODO-DAG (or TODAG), where DAG stands for Directed Acylic Graph, instead of following the more common TODO-list format.
...
---
#Development
The utility is developed using OOP methodologies, and adhereing to the (https://github.com/google/styleguide/blob/gh-pages/pyguide.md)[Google Python style-guide], especially regarding the documentation. Is encouraged Test-Drived-Development, as the whole utility will be tested periodically using Continuous Integration practices. Up to now there is no plan in writing a external documentation as the in-code documentation should be enough.
